...
-- invoices (periode_dari/sampai adalah tipe DATE — tidak bisa SET DEFAULT '' string kosong)
DO $$ BEGIN ALTER TABLE public.invoices ALTER COLUMN order_id      DROP NOT NULL; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.invoices ALTER COLUMN periode_dari   DROP NOT NULL; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.invoices ALTER COLUMN periode_sampai DROP NOT NULL; EXCEPTION WHEN OTHERS THEN NULL; END $$;
