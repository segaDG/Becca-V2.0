...
const App = {
  ...
  _MODULE_MAP: {
    ...
    kas       : 'js/modules/kas.js?v=20260507b',
    'daily-order': 'js/modules/daily-order.js?v=20260507b',
    inventory : 'js/modules/inventory.js?v=20260507b',
    employee  : 'js/modules/employee.js?v=20260505a',
    ap        : 'js/modules/ap.js?v=20260507a',
    po        : 'js/modules/po.js?v=20260507a',
