...
const App = {
  ...
  _MODULE_MAP: {
    ...
    invoice   : 'js/modules/invoice.js?v=20260401e',
    customer  : 'js/modules/customer.js?v=20260331j',
    news      : 'js/modules/news.js?v=20260330o',
    kas       : 'js/modules/kas.js?v=20260401g',
    'daily-order': 'js/modules/daily-order.js?v=20260401e',
    inventory : 'js/modules/inventory.js?v=20260401e',
    employee  : 'js/modules/employee.js?v=20260401a',
    ap        : 'js/modules/ap.js?v=20260331f',
    po        : 'js/modules/po.js?v=20260401d',
