...
const App = {
  ...
  _MODULE_MAP: {
    ...
    kas       : 'js/modules/kas.js?v=20260331j',
    'daily-order': 'js/modules/daily-order.js?v=20260331w',
    inventory : 'js/modules/inventory.js?v=20260331f',
    employee  : 'js/modules/employee.js?v=20260330g',
    ap        : 'js/modules/ap.js?v=20260331c',
