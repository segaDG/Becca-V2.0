...
const App = {
  ...
  _MODULE_MAP: {
    ...
    customer  : 'js/modules/customer.js?v=20260331i',
    news      : 'js/modules/news.js?v=20260330o',
    kas       : 'js/modules/kas.js?v=20260331e',
    'daily-order': 'js/modules/daily-order.js?v=20260331q',
    inventory : 'js/modules/inventory.js?v=20260331c',
