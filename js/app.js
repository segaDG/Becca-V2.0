...
const App = {
  ...
  _MODULE_MAP: {
    ...
    invoice   : 'js/modules/invoice.js?v=20260331f',
    customer  : 'js/modules/customer.js?v=20260331h',
    news      : 'js/modules/news.js?v=20260330o',
    kas       : 'js/modules/kas.js?v=20260331c',
    'daily-order': 'js/modules/daily-order.js?v=20260331o',
    inventory : 'js/modules/inventory.js?v=20260331b',
    employee  : 'js/modules/employee.js?v=20260330g',
    ap        : 'js/modules/ap.js?v=20260331a',
