...
const App = {
  ...
  _MODULE_MAP: {
    ...
    kas       : 'js/modules/kas.js?v=20260405f',
    'daily-order': 'js/modules/daily-order.js?v=20260405f',
    inventory : 'js/modules/inventory.js?v=20260405f',
    employee  : 'js/modules/employee.js?v=20260401b',
    ap        : 'js/modules/ap.js?v=20260405g',
