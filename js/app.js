...
const App = {
  ...
  _MODULE_MAP: {
    ...
    kas       : 'js/modules/kas.js?v=20260405j',
    'daily-order': 'js/modules/daily-order.js?v=20260405j',
    inventory : 'js/modules/inventory.js?v=20260405j',
    employee  : 'js/modules/employee.js?v=20260401b',
    ap        : 'js/modules/ap.js?v=20260405j',
