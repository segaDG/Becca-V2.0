...
const App = {
  ...
  _MODULE_MAP: {
    ...
    kas       : 'js/modules/kas.js?v=20260331g',
    'daily-order': 'js/modules/daily-order.js?v=20260331s',
    inventory : 'js/modules/inventory.js?v=20260331e',
    employee  : 'js/modules/employee.js?v=20260330g',
    ap        : 'js/modules/ap.js?v=20260331b',
