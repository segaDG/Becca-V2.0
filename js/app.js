...
const App = {
  ...
  _MODULE_MAP: {
    ...
    kas       : 'js/modules/kas.js?v=20260506b',
    'daily-order': 'js/modules/daily-order.js?v=20260506a',
    inventory : 'js/modules/inventory.js?v=20260506b',
    employee  : 'js/modules/employee.js?v=20260505a',
    ap        : 'js/modules/ap.js?v=20260506a',
