...
const App = {
  ...
  _MODULE_MAP: {
    dashboard : 'js/modules/dashboard.js?v=20260505a',
    order     : 'js/modules/order.js?v=20260428a',
    invoice   : 'js/modules/invoice.js?v=20260505c',
    customer  : 'js/modules/customer.js?v=20260428a',
    news      : 'js/modules/news.js?v=20260401a',
    kas       : 'js/modules/kas.js?v=20260506d',
    'daily-order': 'js/modules/daily-order.js?v=20260507a',
    inventory : 'js/modules/inventory.js?v=20260506c',
    employee  : 'js/modules/employee.js?v=20260505a',
    ap        : 'js/modules/ap.js?v=20260506b',
    po        : 'js/modules/po.js?v=20260505c',
