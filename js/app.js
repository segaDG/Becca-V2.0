...
const App = {
  ...
  _MODULE_MAP: {
    ...
    kas       : 'js/modules/kas.js?v=20260405q',
    'daily-order': 'js/modules/daily-order.js?v=20260405q',
    inventory : 'js/modules/inventory.js?v=20260405q',
    employee  : 'js/modules/employee.js?v=20260401b',
    ap        : 'js/modules/ap.js?v=20260405q',
    po        : 'js/modules/po.js?v=20260402d',
    task      : 'js/modules/task.js?v=20260330i',
    delivery  : 'js/modules/delivery.js?v=20260405q',
    menu      : 'js/modules/menu.js?v=20260404f',
    chat      : 'js/modules/chat.js?v=20260405a',
    personal  : 'js/modules/personal.js?v=20260405q',
