...
const App = {
  ...
  _MODULE_MAP: {
    ...
    order     : 'js/modules/order.js?v=20260330d',
    invoice   : 'js/modules/invoice.js?v=20260329e',
    customer  : 'js/modules/customer.js?v=20260330c',
    news      : 'js/modules/news.js?v=20260330n',
    ...
    task      : 'js/modules/task.js?v=20260330h',
