...
const App = {
  ...
  _MODULE_MAP: {
    ...
    invoice   : 'js/modules/invoice.js?v=20260407b',
    customer  : 'js/modules/customer.js?v=20260407a',
    news      : 'js/modules/news.js?v=20260401a',
    kas       : 'js/modules/kas.js?v=20260407a',
    'daily-order': 'js/modules/daily-order.js?v=20260409a',
    inventory : 'js/modules/inventory.js?v=20260407a',
    employee  : 'js/modules/employee.js?v=20260408a',
    ap        : 'js/modules/ap.js?v=20260407a',
    po        : 'js/modules/po.js?v=20260402d',
    task      : 'js/modules/task.js?v=20260330i',
    delivery  : 'js/modules/delivery.js?v=20260407a',
    menu      : 'js/modules/menu.js?v=20260409c',
    chat      : 'js/modules/chat.js?v=20260408d',
    personal  : 'js/modules/personal.js?v=20260407a',
    report    : 'js/modules/report.js?v=20260326r',
    settings  : 'js/modules/settings.js?v=20260405a',
  },
