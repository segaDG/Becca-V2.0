...
const Auth = {
  ...
  _defaultPrivileges: {
    ...
    operator: { dashboard:'view', order:'all', invoice:'view', customer:'view', inventory:'all', kas:'view', ap:'view', po:'all', task:'all', 'daily-order':'all', delivery:'all', menu:'view', chat:'all', personal:'all', report:'view', news:'view', haccp:'all' },
